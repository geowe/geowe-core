...
@ApplicationScoped
public class InfoRasterTool extends LayerTool {
	...
	@Inject
	public InfoRasterTool(LayerManagerWidget layerTreeWidget, GeoMap geoMap) {
	...
	@Override
	public void onClick() {
		Layer layer = getSelectedRasterLayer();
		rasterInfoDialog.setSelectedLayer(layer);
		rasterInfoDialog.show();
	}

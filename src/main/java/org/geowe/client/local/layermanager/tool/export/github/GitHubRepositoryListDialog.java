...
* **/
@ApplicationScoped
public class GitHubRepositoryListDialog extends Dialog { //implements GitHubEventListener<GitHubRepositoryList> {
	
//	@Inject
//	private GitHubGetRepositoriesRequest<GitHubRepositoryList> gitHubGetRepositoriesRequest;
...
//	@Override
//	public void onFinish(GitHubRepositoryList response) {
//		setData(response);		
//	}
}
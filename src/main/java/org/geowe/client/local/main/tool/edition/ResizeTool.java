 ...
 */
@ApplicationScoped
public class ResizeTool extends ToggleTool implements DrawTool{
	...
	@Inject
	public ResizeTool(GeoMap geoMap, LayerManagerWidget layerManager) {
		super(UIMessages.INSTANCE.resizeToolText(), ImageProvider.INSTANCE
				.scale(), geoMap, layerManager);
		setToolTipConfig(createTooltipConfig(
				UIMessages.INSTANCE.resizeToolText(),
				UIMessages.INSTANCE.resizeToolTip(), Side.LEFT));
		setEnabled(false);
	}
	...
	public Control createDrawTool(Layer layer) {
		return mapControlFactory.createEditingControl( ModifyFeature.RESIZE, layer, getOnModificationStartListener()); 
	}

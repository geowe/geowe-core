 ...
 */
@Portable
public class GitHubRepositoryAttributeBean implements Serializable {
	private static final long serialVersionUID = 77109489576386882L;
	
	private Integer attributeId;
	private String attributeName;
	private String attributeFullName;

	public GitHubRepositoryAttributeBean() {
		
	}
	public GitHubRepositoryAttributeBean(@MapsTo("id") Integer id, @MapsTo("name") String name, @MapsTo("fullName")String fullName) {
		this.attributeId = id;
